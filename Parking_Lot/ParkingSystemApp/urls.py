...
urlpatterns = [
    ...
    path('parking_lot_api/', views.ParkingApi.as_view(), name='parking_list'),
    ...
    path('entry_time_and_charges/', views.car_entry_time_and_charges, name='entry_time'),
    ...
    path('all_vehicle_info_park_in_a_row/', views.get_location_and_info_of_vehicles_in_row,
         name='all_vehicle_info_park_in_a_row'),
